...
public abstract class BaseController<T extends BaseEntity> {
    ...
    public JsonResult findItems(PageInfo info) {
    ...
    public JsonResult findItemByPrimaryKey(Integer id) {
     ...
     * @return 更新后的记录
     */
    public JsonResult updateItemByPrimaryKey(T item) {
    ...
    public JsonResult upgradeItemByPrimaryKey(Integer id, T item) {
        if (BaseUtils.isNullOrEmpty(item)) {
            return JsonResult.error("Get params error");
        }
        item.setId(id);
    ...
    public JsonResult filesUpload(ServletRequest req) {
    ...
    public JsonResult fileUpload(ServletRequest req, MultipartFile file) {
    ...
    public JsonResult addItem(T item) {
        if (BaseUtils.isNullOrEmpty(item)) {
    ...
    public JsonResult deleteItemByPrimaryKey(Integer id) {
    ...
    public JsonResult findItemsByConditions(T item) {
